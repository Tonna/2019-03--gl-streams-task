...
for i in range(1,10):
    ...
    mapped = list(map(lambda x: x * 3 - 14, l2))
    ...
    results.append("new int[]{{{}}},{},{},{},{},{},new int[]{{{}}},new int[]{{{}}},new int[]{{{}}}, new int[]{{{}}},{},{}".format(to_java_arr(l2), average, max(l2), min(l2), len(l2), to_java_int(sum(l2)), to_java_arr(l2), to_java_arr(mapped), to_java_arr(flatten), to_java_arr(flatten2), to_java_int(reduce1), to_java_int(reduce2)))
    out = []
